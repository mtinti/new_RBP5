...
var tour = new Tour({
  steps: [
...

    {
      ...
      content: 'Hovering over the dots to highlight the gene in the MA and Volcano plot. It also load the raw data for the Bar chart'
    },
...

  {
      ...
      on the plots and load the raw data on the Bar chart"
  },
...

  {
    ...
    content: "Hovering on the gene id will highlight the gene in the Table and MA/Volcano plots"
  },
